...
- Keep user-facing behavior documented in both `README.md` and `README.en.md`. Keep credential and storage guidance synchronized in `references/workbuddy-setup.md` and `references/workbuddy-setup.en.md`.
